...
{
    [DriverSupported("CWUDPReportProtocol")]
    [DriverInfo("CWUDPReport", "V1.0.0", "Copyright IoTGateway© 2022-06-04")]
    public class CWUDPReceiver : IDriver
    {
        ...
        public CWUDPReceiver(string device, ILogger logger)
        {
            _device = device;
            _logger = logger;
